...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  <p className="text-lg font-semibold text-white">Deadlock France</p>
</NavLink>
    ...
    {/* <!-- Deuxième carré --> */}
    <path
      d="M15.4688 0.956299H11.897C10.9407 0.956299 10.1532 1.7438 10.1532 2.70005V6.27192C10.1532 7.22817 10.9407 8.01567 11.897 8.01567H15.4688C16.4251 8.01567 17.2126 7.22817 17.2126 6.27192V2.70005C17.2126 1.7438 16.4251 0.956299 15.4688 0.956299ZM15.9751 6.30005C15.9751 6.5813 15.7501 6.8063 15.4688 6.8063H11.897C11.6157 6.8063 11.3907 6.5813 11.3907 6.30005V2.72817C11.3907 2.44692 11.6157 2.22192 11.897 2.22192H15.4688C15.7501 2.22192 15.9751 2.44692 15.9751 2.72817V6.30005Z"
    />
    {/* <!-- Troisième carré --> */}
    <path
      d="M6.10322 9.9563H2.53135C1.5751 9.9563 0.787598 10.7438 0.787598 11.7V15.2719C0.787598 16.2282 1.5751 17.0157 2.53135 17.0157H6.10322C7.05947 17.0157 7.84697 16.2282 7.84697 15.2719V11.7C7.8751 10.7438 7.0876 9.9563 6.10322 9.9563ZM6.60947 15.3C6.60947 15.5813 6.38447 15.8063 6.10322 15.8063H2.53135C2.2501 15.8063 2.0251 15.5813 2.0251 15.3V11.7282C2.0251 11.4469 2.2501 11.2219 2.53135 11.2219H6.10322C6.38447 11.2219 6.60947 11.4469 6.60947 11.7282V15.3Z"
    />
    {/* <!-- Quatrième carré --> */}
    <path
      d="M15.4688 9.9563H11.897C10.9407 9.9563 10.1532 10.7438 10.1532 11.7V15.2719C10.1532 16.2282 10.9407 17.0157 11.897 17.0157H15.4688C16.4251 17.0157 17.2126 16.2282 17.2126 15.2719V11.7C17.2126 10.7438 16.4251 9.9563 15.4688 9.9563ZM15.9751 15.3C15.9751 15.5813 15.7501 15.8063 15.4688 15.8063H11.897C11.6157 15.8063 11.3907 15.5813 11.3907 15.3V11.7282C11.3907 11.4469 11.6157 11.2219 11.897 11.2219H15.4688C15.7501 11.2219 15.9751 11.4469 15.9751 11.7282V15.3Z"
    />
              </svg>
              Tableau de bord
            </NavLink>
              ...
              <li>
                <NavLink
                  to="/admin/patchnotesManager"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('patchnotesManagement') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
